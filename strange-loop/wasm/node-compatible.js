/**
 * Node.js Compatible WASM Module for O(log n) Sublinear Solver
 *
...
// Export the compatible module - support both CommonJS and ES modules
const moduleExports = {
  WasmSublinearSolver,
  async default(wasmBytesInput) {
...
// Support ES modules
export const { WasmSublinearSolver } = moduleExports;
